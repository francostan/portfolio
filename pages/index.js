    ...
    <Scroller>
      <Head>
        ...
        <div className="bg-black min-h-screen">
          ...
          <div className="fixed inset-0 max-w-6xl mx-auto min-h-screen border-l border-r border-zinc-700 bg-primary p-10 text-white ">
            <div className="max-w-6xl mx-auto relative p-5 sm:px-24 p-0">
              <NavBar />
